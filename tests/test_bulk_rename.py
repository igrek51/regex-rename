...
def test_bulk_rename():
    ...
    try:
        ...
        bulk_rename(r'.+\((\d{1,2})\).mp3', r'\1 Niezwyciężony.mp3', rename=False, full=False, pad_to=2)
        bulk_rename(r'.+\((\d{1,2})\).mp3', r'\1 Niezwyciężony.mp3', rename=True, full=False, pad_to=2)
